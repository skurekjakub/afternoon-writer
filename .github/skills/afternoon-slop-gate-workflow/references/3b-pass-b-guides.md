# Phase 3 Route: Pass B Guides

Pass B owns the higher-context guides:

- `gpt-5-prose-issues.md`
- `narrator-seep-guide.md`
- `phantom-concreteness-guide.md`
- `fake-simplification-guide.md`

Audit only these four guides in this run.
...
You should have:
- audited all four pass B guides
- kept fake simplification as its own guide section
- kept the run scoped to the pass B guide pack
